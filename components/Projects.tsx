      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="group bg-term-card border border-term-border hover:border-term-purple transition-all p-8 relative overflow-hidden flex flex-col">
            ...
            <a href="https://github.com/Gefferson-Souza/goiasscript" className="inline-flex items-center gap-2 text-sm font-mono text-white hover:text-term-purple border-b border-transparent hover:border-term-purple transition-all w-fit">
              read_documentation
              <ArrowRight className="w-4 h-4" />
            </a>
          </div>
